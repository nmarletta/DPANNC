...
public class AIMNc {
        ...
        Map<String, Vector> nodes; // label -> vector
        Map<String, List<String>> buckets; // leafID -> list of vectors (leafID is the path)
        List<String> query;

        public AIMNc(double sensitivity, double epsilon, double delta) {
        ...
        public class Node {
            ...
            public void insertPoint(Vector v) {
                if (isLeaf) {
                    ...
                    // }
                    buckets.putIfAbsent(id, new ArrayList<String>()).add(v.getLabel());
                    count++;
                } else {
        ...
        public void saveTreeToDB(Node n) {
            DB.insertToNodes(n.id(), n.isLeaf(), n.gaussian().toString(), n.count());
